// --------------------------------------------------------------------------------
// <copyright file="RpcConnectHelper.cs" company="Private">
...
namespace ClosetRpc.Net.Util
{
    ...
    /// Connects.
    /// </summary>
    public class RpcConnectHelper
    {
        #region Fields

        private readonly RpcClient client;

        private readonly ILog log = LogManager.GetLogger<RpcConnectHelper>();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RpcConnectHelper"/> class.
        /// </summary>
        /// <param name="client">RpcClient instance.</param>
        public RpcConnectHelper(RpcClient client)
        {
            this.client = client;
        }
