...
public:
  ...
  const std::string &cpp_name() const { return cpp_name_; }
  void set_cpp_name(const std::string &name) { cpp_name_ = name; }

  const std::string &csharp_name() const { return csharp_name_; }
  void set_csharp_name(const std::string &name) { csharp_name_ = name; }
...
public:
  ...
  void set_arglist_typename(const std::string &value) {
    arglist_typename_ = value;
  }
  ...
  bool ParseFromMethodDescriptor(
      const google::protobuf::MethodDescriptor *method);
  bool CreateProperty(const google::protobuf::MethodDescriptor *method,
                      bool setter);
...
public:
  ...
  void set_event_source(bool is_event_source) {
    is_event_source_ = is_event_source;
  }
...
class ModuleModel {
public:
  ModuleModel(const google::protobuf::FileDescriptor *file);

  const std::vector<ServiceModel> &services() const { return services_; }
...
bool CreateModuleModel(const google::protobuf::FileDescriptor *file,
